...
public class UI {
	...
	GamePanel gp;
	Graphics2D g2;
	public Font arial_30, arial_48B;
	...
	public UI(GamePanel gp) {
		this.gp = gp;
		arial_30 = new Font("Pixel Operator", Font.PLAIN, 34);
		arial_48B = new Font("Pixel Operator", Font.BOLD, 48);
	...
	public void drawMonsterLife() {
		...
		for(int i = 0; i < gp.monster[1].length; i++) {
			...
			if(monster != null && gp.monster[gp.currentMap][i].inCamera() == true) {
				...
				if(monster.hpBarOn == true && monster.boss == false) { // DRAWING NORMAL MONSTER HP BAR
	...
	public void drawMessage() {
		...
		for(int i = 0; i <message.size(); i++) {
			...
			if(message.get(i)!= null) {
				...
				int counter = messageCounter.get(i) + 3;
...
//				currentDialogue = npc.dialogues[npc.dialogueSet][npc.dialogueIndex];
	...
	// save game UI
	public void drawSaveGameScreen() {
			switch(subState) {
			case 0: save_select(); break;
			case 1: save_yes(); break;
			}
			gp.keyH.enterPressed = false;
	...
	public void drawInventory(Entity entity, boolean cursor) {
			...
			int textY = dFrameY + 15 + gp.tileSize/2;
			g2.setFont(g2.getFont().deriveFont(24F));
...
//				g2.drawString("Durability: " + entity.inventory.get(itemIndex).durability, textX, textY+100);
	...
	public void options_fullScreenNotification(int frameX, int frameY) {
			...
			currentDialogue = "The change will take \neffect after FullScreen restart ";

...
public class KeyHandler implements KeyListener {
	...
	@Override
	public void keyTyped(KeyEvent e) { //unused here
	...
	public void keyPressed(KeyEvent e) {
		...
		//SAVE STATE
		else if (gp.gameState == gp.saveState) {saveState(code);}
	...
	public void playState(int code) {
		...
		if(code == KeyEvent.VK_R) {
			...
			case 0: gp.tileM.loadMap("/maps/overworld.txt", 0); break;
			case 1: gp.tileM.loadMap("/maps/interior_woodHut.txt", 1); break;
			}
	...
	public void keyReleased(KeyEvent e) {
		...
		if(code == KeyEvent.VK_M) {shotKeyPressed = false;}

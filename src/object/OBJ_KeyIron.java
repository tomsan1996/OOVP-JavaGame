...
public class OBJ_KeyIron extends Entity{
	public static final String objName = "Iron Key";
	GamePanel gp;

	public OBJ_KeyIron(GamePanel gp) {
		super(gp);
		this.gp = gp;
		...
		name = objName;
		stackable = true;
		down1 = setup ("/objects/keys/ironKey",gp.tileSize,gp.tileSize);
		down3 = setup ("/objects/keys/ironKey",gp.tileSize,gp.tileSize);
		description = "["+name+"]\n It Opens a door.";
		price = 2000;
		setDialogue();
	...
	public boolean use(Entity entity) {
		...
		int objIndex = getDetected(entity, gp.obj,"Iron Door");
		if (objIndex != 999) {
			gp.playSE(49);
